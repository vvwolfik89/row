  ...
  module Athletes
    module Admin
      class AthletesController < ::Refinery::AdminController
        ...
        def athlete_params
          params.require(:athlete).permit(:first_name, :last_name, :patronymic, :bday, :rowing_type, :territorial_unit, :educational_institution, :organisation, :first_organisation, :icon_id, :gender, {first_coach_ids: []}, {current_coach_ids: []},
                                          {
